...
function getTools () {
    ...
    },
    {
        ...
        packages: [
			...
			{
				displayName: 'Microsoft 365 Business Standard', pricePerMonth: '10.50', maxParticipants: 250, features: [
					'1 TB Dateien pro Nutzer im Chat einfügen',
					'Konferenzen planen',
					'Aufzeichnung',
					'Mehrstufige Authentifizierung',
	...
	},
	{
		...
		packages: [
			...
			{
				displayName: 'Premium', pricePerMonth: 'Abhängig von der Teilnehmeranzahl', maxParticipants: 100, features: [
